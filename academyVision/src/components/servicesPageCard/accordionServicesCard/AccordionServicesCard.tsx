...
import web from "../../../assets/servicesCard/design.webp";
import smm from "../../../assets/servicesCard/geld.webp";
import seo from "../../../assets/servicesCard/team.webp";
...
const AccordionServicesCard: React.FC = () => {
  ...
  const homeCards: ServicesPageCard[] = t("servicesPageCard", {
    returnObjects: true,
  });
        ...
        {homeCards.map((card) => (
          ...
          >
            ...
            <NavLink className="text-decoration-none" to="/services">
              <Accordion.Body
                className="d-flex justify-content-end fs-2"
