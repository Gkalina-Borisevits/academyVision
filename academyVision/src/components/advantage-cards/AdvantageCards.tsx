...
const advantageIcons: string[] = [global, adaptiv, opacity, tim, response, protection, innovativ, client]
            ...
            {advantageCards.map((card) => (
                ...
                >
                    <Card.Header className={styles.advantageHeader}>
                        <Card.Img variant="left" className={styles.logo} src={advantageIcons[card.id]} />
